...
public class InvalidDocument extends RuntimeException {
    ...
    public ResponseEntity<ExceptionResponse> invalidDocument(Exception exception) {
        ...
        return new ResponseEntity<>(new ExceptionResponse(ErrorCodes.INVALID_DOCUMENT.getCode(),exception.getMessage(),false, LocalDateTime.now()), HttpStatus.BAD_REQUEST);
